...
public class Assignment implements Instruction, Expression {
	...
	public boolean checkType() {
		...
		Type _assignableType = this.assignable.getType();
		if (_valueType.compatibleWith(_assignableType)) {
			return true;
		} else {
			Logger.error("Type mismatch in assignment: expected " + _assignableType + ", got " + _valueType);
			return false;
		}
	}
